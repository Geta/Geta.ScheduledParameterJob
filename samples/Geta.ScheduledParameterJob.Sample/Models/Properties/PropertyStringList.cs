...
namespace Geta.ScheduledParameterJob.Sample.Models.Properties
{
    /// <summary>
    /// Property type for storing a list of strings
    /// </summary>
    /// <remarks>For an example, see <see cref="Geta.ScheduledParameterJob.Sample.Models.Pages.SitePageData"/> where this property type is used for the MetaKeywords property</remarks>
